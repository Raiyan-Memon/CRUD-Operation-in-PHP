...
<body>
    ...
    <form method="POST" action="add.php">
        ...
        Title:<br> <input type="text" class="int" name="title" id="title" placeholder="Add your title here"><br>
        Description:<br> <input type="text" class="int" name="descr" id="descr"
            placeholder="Description about the note"><br>
...
// echo $row['Sr.No']. "<br>title = " .$row['title']. "<br>description= ".$row['descr']."<br><br>"
   ...
   ?>
    ...
    <br>
    Note:
    <p><a href="reset_table.php" class="sub">Click here</a> to reset Serial number.
